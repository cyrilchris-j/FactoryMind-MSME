...
export default function AICopilotPage() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const API_KEY = "AQ.Ab8RN6IZrw05WwIQwnyULMBuhRyT71vmdcFkaTZI2Q5l-wtwTg";
      
      // Formatting previous messages for context
      ...
      const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${API_KEY}`, {
        ...
        body: JSON.stringify({
          systemInstruction: {
            parts: [{
              text: "You are an AI Factory Copilot for an MSME factory. You help analyze production data, predict outcomes, and provide actionable insights. Format your answers clearly with markdown."
            }]
          },
          contents: [
            ...history,
      ...
      // Fallback to local logic if API fails (e.g. invalid key)
    ...
    <DashboardLayout>
      <div className="h-[calc(100vh-8rem)] flex flex-col">
        ...
        <div className="mb-4">
          ...
          <p className="text-muted">Ask anything about your factory operations</p>
        </div>
                ...
                >
                  {message.type === 'recommendation' && (
                    <div className="mb-2 flex items-center space-x-2">
                      ...
                      <span className="text-xs font-medium text-accent">AI Recommendation</span>
                    </div>
                  )}
              ...
              <div className="flex flex-wrap gap-2">
                {examplePrompts.map((prompt, index) => (
                  <button
                    ...
                    className="px-3 py-1.5 text-sm bg-background border border-border rounded-full hover:bg-border transition-colors"
                  >
                    {prompt}
                  </button>
                ))}
          ...
          <div className="p-4 border-t border-border">
            <div className="flex space-x-3">
              ...
              <Button
                ...
                className="bg-primary hover:bg-[#2A4A73]"
              >
