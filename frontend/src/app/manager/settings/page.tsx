...
import { Users, Settings, Bell, Shield, Download } from 'lucide-react';
    ...
    <ManagerLayout>
      <div className="p-8 max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-[#666666]">Manage users, roles, and preferences.</p>
        </div>
              ...
              <Card className="p-6 border-0 shadow-sm rounded-xl bg-white">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-sm text-[#666666]">View active team members and department access.</p>
                  </div>
                </div>
                ...
                <div className="mt-8 border-t border-[#E5E5E5] pt-8">
                   <h3 className="text-md font-bold text-foreground mb-4">Export Directory</h3>
                   <p className="text-sm text-[#666666] mb-4">Download a full CSV of all active employees.</p>
